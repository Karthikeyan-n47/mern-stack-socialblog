      ...
      <div className="termsDesc">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to SocialBlog.
            </p>
            <p>&nbsp;</p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to SocialBlog, accessible from{" "}
              <a
                href="socialblog.com"
        ...
        <ul>
          <li>
            ...
            <a
              href="socialblog.com/contact"
              rel="external nofollow noopener"
              target="_blank"
            >
              socialblog.com/contact
            </a>
          </li>
        </ul>
      </div>
